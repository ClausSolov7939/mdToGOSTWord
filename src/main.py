...
setupFile = open("ОтБергер.json", encoding='utf-8')
...
for newStyle in styleData.keys():
    ...
    currentStyle.quick_style = True
    # print(currentStyle)
    # -------- font setting -----------
    font_format = currentStyle.font
    font_style = styleData[newStyle]["font"]
    font_format.color.rgb = RGBColor(0x0, 0x0, 0x0)
    ...
    # Запрет висящих строк - Widow/Orphan control
    ...
    # Не разрывать абзац - Keep lines together
    paragraph_format.keep_together = paragraph_style["keep_together"]
    # С новой страницы - Page Break before
